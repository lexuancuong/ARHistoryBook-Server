...
let remove = (user_id,sec_id) => {
  return db
  .query("DELETE FROM sectionstatus where user_id = $1 AND sec_id = $2", [user_id,sec_id])
  .then(function({rows}) {
...
//Create a new Section Status Row
